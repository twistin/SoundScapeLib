    ...
    try {
      ...
      const schema = {
        ...
        properties: {
          ...
          project: { type: Type.STRING, description: "A suitable project name this recording would belong to, like 'Urban Explorations' or 'Nature Field Recordings'." },
          description: { type: Type.STRING, description: "A detailed, evocative description of the soundscape, capturing the atmosphere and specific sounds heard." },
          locationName: { type: Type.STRING, description: "A plausible specific location for this recording, like 'Central Park, New York' or 'Sahara Desert, Morocco'." },
          equipment: { type: Type.STRING, description: "Suggest a plausible set of professional recording equipment that would be used to capture this sound. e.g., 'Sennheiser MKH 8040, Sound Devices MixPre-6'." },
          soundType: { type: Type.STRING, enum: ['Forest', 'Urban', 'Marine', 'Desert', 'Industrial'], description: "Categorize the sound into one of the provided types." }
        },
