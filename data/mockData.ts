...
export const mockSessions: SoundscapeSession[] = [
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/ambiences/forest_morning.ogg',
    ...
    privacy: 'public',
    weather: { temperature: 18, condition: 'Partly Cloudy', windSpeed: 5, humidity: 60 },
    tags: {
        biotic: ['Birds', 'Insects'],
        geophonic: ['Water', 'Wind'],
        anthropophonic: []
    }
  },
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/transportation/car_driving_by.ogg',
    ...
    tags: {
        biotic: [],
        geophonic: [],
        anthropophonic: ['Traffic', 'Sirens', 'Voices']
    }
  },
  {
    id: '3',
    ...
    attachments: [],
    privacy: 'link',
    weather: { temperature: 15, condition: 'Windy', windSpeed: 25, humidity: 80 },
    tags: {
        biotic: ['Seagulls'],
        geophonic: ['Waves', 'Wind'],
        anthropophonic: []
    }
  },
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/weather/heavy_wind.ogg',
    equipment: 'LOM Usi Pro, Sony PCM-D100',
    soundType: 'Desert',
    date: '2024-01-10',
    attachments: [],
    privacy: 'public',
    weather: { temperature: 35, condition: 'Clear', windSpeed: 15, humidity: 10 },
    tags: {
        biotic: [],
        geophonic: ['Wind', 'Sand'],
        anthropophonic: []
  ...
  },
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/water/steam_train_whistle.ogg', // Reusing reliable asset
    ...
    tags: {
        biotic: [],
        geophonic: ['Water'],
        anthropophonic: ['Boat Engine', 'Rigging']
    }
  },
    {
    id: '7',
    ...
    attachments: [],
    privacy: 'public',
    weather: { temperature: 28, condition: 'Sunny', windSpeed: 2, humidity: 45 },
    tags: {
        biotic: ['Crickets', 'Bees'],
        geophonic: ['Wind'],
        anthropophonic: []
    }
  },
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/ambiences/industrial_hum.ogg',
